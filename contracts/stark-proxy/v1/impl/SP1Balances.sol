 ...
 * @author dYdX
 *
 * @notice Contains common constants and functions related to token balances.
 */
abstract contract SP1Balances is SP1Roles {
  ...
  function getAllocatedBalanceCurrentEpoch() public view returns (uint256) {
    return LIQUIDITY_STAKING.getAllocatedBalanceCurrentEpoch(address(this));
  }

  function getAllocatedBalanceNextEpoch() public view returns (uint256) {
  ...
  function getBorrowedAndDebtBalance() public view returns (uint256) {
