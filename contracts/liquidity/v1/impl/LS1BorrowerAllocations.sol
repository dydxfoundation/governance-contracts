 ...
 */
abstract contract LS1BorrowerAllocations is LS1StakedBalances {
  ...
  function __LS1BorrowerAllocations_init() internal {
   ...
   */
  function getAllocationFractionCurrentEpoch(address borrower) public view returns (uint256) {
   ...
   */
  function getAllocationFractionNextEpoch(address borrower) public view returns (uint256) {
   ...
   */
  function getAllocatedBalanceCurrentEpoch(address borrower) public view returns (uint256) {
   ...
   */
  function getAllocatedBalanceNextEpoch(address borrower) public view returns (uint256) {
   ...
   */
  function _setBorrowerAllocations(address[] calldata borrowers, uint256[] calldata newAllocations)
    internal
  {
   ...
   */
  function _getAllocatedBalanceForNewBorrowing(address borrower) internal view returns (uint256) {
  ...
  function _loadBorrowerAllocation(address borrower)
    private
    view
