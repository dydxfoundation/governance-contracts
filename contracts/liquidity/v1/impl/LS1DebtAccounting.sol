 ...
 */
abstract contract LS1DebtAccounting is LS1BorrowerAllocations {
   ...
   */
  function markDebt(address[] calldata borrowers) external nonReentrant returns (uint256) {
   ...
   */
  function isBorrowerOverdue(address borrower) public view returns (bool) {
   ...
   */
  function _convertInactiveBalanceToDebt(uint256 shortfallDebt) private {
