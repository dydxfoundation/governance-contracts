 ...
 */
abstract contract LS1Operators is LS1Staking {
   ...
   */
  function decreaseStakerDebt(address staker, uint256 amount)
    external
   ...
   * @return The new debt balance.
   */
  function decreaseBorrowerDebt(address borrower, uint256 amount)
    external
    onlyRole(DEBT_OPERATOR_ROLE)
    nonReentrant
    returns (uint256)
