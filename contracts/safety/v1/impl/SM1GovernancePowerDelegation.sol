 ...
 *
 *  Internally, makes use of staked balances denoted in staked units, but returns undlerying token
  ...
  IGovernancePowerDelegationERC20
{
    ...
    external
  {
    ...
    require(signer != address(0), 'SM1GovernancePowerDelegation: INVALID_SIGNATURE');
    require(nonce == _NONCES_[signer]++, 'SM1GovernancePowerDelegation: INVALID_NONCE');
    require(block.timestamp <= expiry, 'SM1GovernancePowerDelegation: INVALID_EXPIRATION');
  ...
  function _delegateByType(
    ...
    require(delegatee != address(0), 'SM1GovernancePowerDelegation: INVALID_DELEGATEE');
