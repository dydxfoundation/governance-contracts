  ...
  SM1EpochSchedule
{
  ...
  constructor(
    ...
    require(distributionEnd >= distributionStart, 'SM1Rewards: Invalid parameters');
   ...
   */
  function __SM1Rewards_init() internal {
   ...
   */
  function _setRewardsPerSecond(uint256 emissionPerSecond, uint256 totalStaked) internal {
   ...
   */
  function _settleGlobalIndexUpToEpoch(uint256 totalStaked, uint256 epochNumber)
    internal
    returns (uint256)
  {
   ...
   * @return The new global index.
   */
  function _settleGlobalIndexUpToTimestamp(uint256 totalStaked, uint256 settleUpToTimestamp)
    private
    returns (uint256)
  {
