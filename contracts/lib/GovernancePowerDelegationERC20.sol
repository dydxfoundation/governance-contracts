...
/**
 * @notice implementation of the dYdX token contract
 * @author dYdX
 */
abstract contract GovernancePowerDelegationERC20 is ERC20, IGovernancePowerDelegationToken {
   ...
   * A snapshots mapping will need to be added in case a mint function is added to the DYDX token in the future
   **/
   ...
   * the DYDX token and staked DYDX token already include a mapping for the snapshots, so we require contracts
