...
/**
 * @title StakedToken
 * @notice Contract to stake DYDX token, tokenize the position and get rewards, inheriting from a distribution manager contract
 * @author dYdX
 **/
  ...
  DistributionManager
{
  ...
  constructor(
    ...
    _governor = ITransferHook(governance);
  ...
  function _beforeTokenTransfer(
    ...
    ITransferHook governor = _governor;
    if (governor != ITransferHook(0)) {
      governor.onTransfer(from, to, amount);
    }
  }
